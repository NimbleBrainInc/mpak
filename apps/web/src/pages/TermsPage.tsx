    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="space-y-10 text-mpak-gray-600">
        <section>
          ...
          <p>
            By using mpak.dev or the mpak CLI ("the Service"), you agree to these terms. The Service
            is operated by {siteConfig.operator.name} ("{siteConfig.operator.shortName}", "we",
            "us"). If you don't agree, don't use the Service.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              The package does not contain malware, backdoors, or intentionally malicious code.
            </li>
            <li>The package metadata (name, description, license) is accurate.</li>
            <li>
              You comply with the license terms of any third-party code included in your package.
            </li>
          </ul>
          <p className="mt-3">
            You retain ownership of packages you publish. By publishing, you grant{' '}
            {siteConfig.operator.shortName} a license to host, distribute, scan, and display your
            package through the Service.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              Abuse the registry API (excessive requests, scraping, automated mass publishing).
            </li>
        ...
        <section>
          <h2 className="text-xl font-semibold text-mpak-gray-900 mb-3">
            Trust scores and security scans
          </h2>
          <p>
            mpak provides trust scores and security scan results as informational signals. They are
            not guarantees of safety. You are responsible for evaluating the packages you install.
            We scan packages in good faith but do not warrant that any package is free of
            vulnerabilities.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We may remove packages that violate these terms, contain security vulnerabilities, or
            are subject to valid legal complaints. We will make reasonable efforts to notify
            publishers before removal, except in cases of active security threats.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            mpak is provided "as is." We aim for high availability but don't guarantee uninterrupted
        ...
        <section>
          ...
          <p>
            To the maximum extent permitted by law, {siteConfig.operator.shortName} is not liable
            for any indirect, incidental, or consequential damages arising from your use of the
            Service or any packages obtained through it.
          </p>
        </section>
