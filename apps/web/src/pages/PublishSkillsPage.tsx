  ...
  useSEO({
    ...
    schema: [
      ...
      generateHowToSchema(
        ...
        [
          {
            name: 'Write a SKILL.md',
            text: 'Create a SKILL.md file in your repository with frontmatter (name, version, description, triggers) and markdown instructions for the AI.',
          },
          {
            name: 'Add the GitHub Action',
            text: 'Add the skill-pack GitHub Action to your CI workflow to automatically package and publish skills on release.',
          },
          {
            name: 'Create a release',
            text: 'Create a GitHub release. The action packages the skill, validates the format, and publishes to the registry.',
          },
        ],
      ),
    ],
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <p className="text-mpak-gray-600 mb-12 text-lg">
        Share your expertise with the AI community. Write a SKILL.md, and your skill is discoverable
        and installable across platforms.
      </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="workshop-card workshop-card-purple p-5">
            ...
            <p className="text-sm text-mpak-gray-600">
              Your skill appears in mpak search, browsable by category and tags. Developers find it
              when they need it.
            </p>
          </div>
          <div className="workshop-card workshop-card-purple p-5">
            ...
            <p className="text-sm text-mpak-gray-600">
              Skills follow the Agent Skills specification. They work across Claude Code, and any
          ...
          <div className="workshop-card workshop-card-purple p-5">
            ...
            <p className="text-sm text-mpak-gray-600">
              Semantic versioning, prerelease support, and version history. Users can pin to
              specific versions or track latest.
            </p>
          </div>
          <div className="workshop-card workshop-card-purple p-5">
            ...
            <p className="text-sm text-mpak-gray-600">
              Users install with{' '}
              <code className="text-mpak-gray-800">mpak skill install @you/skill</code>. No manual
              copying, no configuration.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-mpak-gray-600 text-sm mb-2">
                Create a SKILL.md with YAML frontmatter (name, description, category, tags) and
                markdown instructions that teach the AI your expertise.
              </p>
              <a
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-mpak-gray-600 text-sm mb-2">
                ...
                action discovers SKILL.md files in your repo, validates them, packages each into a{' '}
                <code className="bg-mpak-gray-100 px-1.5 py-0.5 rounded text-mpak-gray-800">
                  .skill
                </code>{' '}
                bundle, and publishes to the registry.
              </p>
              <a
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-mpak-gray-600 text-sm">
                Tag and push. The action discovers, validates, packages, and publishes
                automatically.
              </p>
            </div>
          </div>
      ...
      <section className="mb-12">
        <div className="workshop-card workshop-card-purple p-6">
          ...
          <p className="text-sm text-mpak-gray-600 mb-3">
            The skill-pack action automatically discovers all SKILL.md files in your repository. For
            independent versioning across many skills, use release-please with per-skill tags.
          </p>
          <a
