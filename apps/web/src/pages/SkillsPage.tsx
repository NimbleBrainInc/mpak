...
export default function SkillsPage() {
  ...
  useSEO({
    ...
    keywords: ['agent skills', 'ai skills', 'skill registry', 'ai expertise', 'claude skills'],
    schema: schemas,
  });
  ...
  const categoryCounts = skills.reduce(
    (acc, skill) => {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="border-b border-white/[0.08]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 [&>nav]:mb-0">
          <Breadcrumbs items={[{ label: 'Explore', href: '/' }, { label: 'Skills' }]} />
        </div>
      </div>
          ...
          <div className="bg-surface-raised rounded-xl border border-white/[0.08] p-6 mb-8">
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex-1">
                <label
                  htmlFor="search"
                  className="block text-sm font-medium text-mpak-gray-600 mb-2"
                >
                  Search
                </label>
                  ...
                  >
                    ...
                    {skill.tags && skill.tags.length > 0 && (
                      <div className="flex flex-wrap gap-1.5 mb-3">
                        ...
                        {skill.tags.length > 3 && (
                          <span className="text-[0.65rem] text-mpak-gray-400">
                            +{skill.tags.length - 3}
                          </span>
                        )}
                      </div>
                    ...
                    <div className="mt-auto flex items-center gap-2 text-[0.7rem] text-mpak-gray-500 pt-3 border-t border-white/[0.06]">
                      <span
                        className={`inline-flex items-center gap-1 ${catInfo.colorClass} !bg-transparent !border-0 p-0`}
                      >
                        {catInfo.icon}
                        {catInfo.label}
                      </span>
