    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="border-b border-white/[0.08]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 [&>nav]:mb-0">
          <Breadcrumbs items={[{ label: 'Explore', href: '/' }, { label: 'Bundles' }]} />
        </div>
      </div>
      ...
      <div className="border-b border-white/[0.08]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          ...
          <p className="text-mpak-gray-600">MCP server bundles, scanned and scored for security</p>
        </div>
      </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-3 mb-1.5">
                      ...
                      {cert && (
                        <span
                          className={`shrink-0 inline-flex items-center gap-1 text-[0.65rem] font-bold px-1.5 py-0.5 rounded ${cert.bg}`}
                          title={`MTF ${cert.grade} ${cert.name}`}
                        >
                          <svg
                            aria-hidden="true"
