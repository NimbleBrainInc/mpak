  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        {/* Publish a Skill */}
        <Link to="/publish/skills" className="workshop-card workshop-card-purple p-6 block group">
          ...
          <p className="text-sm text-mpak-gray-600 mb-4">
            Share agent skills that teach AI new behaviors. Write a SKILL.md, add the GitHub Action,
            and your skill is discoverable and installable across platforms.
          </p>
