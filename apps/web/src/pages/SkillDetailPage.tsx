...
export default function SkillDetailPage() {
  ...
  const seoTitle = skill ? `${displayName} - Agent Skill` : 'Loading Skill';
  ...
  useSEO({
    ...
    keywords: skill ? [skill.name, 'agent skill', 'claude skill', ...(skill.tags || [])] : [],
    schema: skill
  ...
  const hasOverviewContent =
    hasContent || hasTags || hasCompatibility || hasAllowedTools || hasExamples;
          ...
          <div className="flex flex-col sm:flex-row items-start gap-5">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex flex-col sm:flex-row sm:items-center flex-wrap gap-2 sm:gap-3 mb-1">
                ...
                <span
                  className={`inline-flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded uppercase tracking-wide border ${catInfo.colorClass}`}
                >
                  {catInfo.icon}
                  {catInfo.label}
                </span>
                ...
                <>
                  {!hasOverviewContent && (
                    <div className="text-center py-12">
                      <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-accent-purple-500/10 flex items-center justify-center">
                        <svg
                          aria-hidden="true"
                          className="w-8 h-8 text-accent-purple-400"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <p className="text-mpak-gray-500 max-w-md mx-auto">
                        This skill doesn't have additional metadata like tags, compatibility info,
                        or example prompts. Check the Triggers tab to see how to activate it.
                      </p>
                    </div>
                  )}
                  ...
                  {hasContent && (
                    <section className="mb-10">
                      <MarkdownRenderer accent="purple">{skill.content!}</MarkdownRenderer>
                    </section>
                  )}
                    ...
                    <section className="mb-10">
                      ...
                      <div className="space-y-3">
                        {skill.examples!.map((example) => (
                          <div
                            key={example.prompt}
                            className="bg-surface-raised rounded-lg p-4 border border-white/[0.08]"
                          >
                            <p className="text-mpak-gray-900 font-medium mb-1">
                              "{example.prompt}"
                            </p>
                            {example.context && (
              ...
              {activeTab === 'triggers' &&
                (skill.triggers && skill.triggers.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-mpak-gray-500 max-w-md mx-auto">
                      This skill can be activated by invoking it directly with the Skill tool or by
                      using keywords in your prompt that match its description.
                    </p>
                  </div>
                ))}
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-2">
                              ...
                              {version.version === skill.latest_version && (
                                <span className="text-xs bg-accent-purple-500 text-white px-2 py-0.5 rounded font-medium">
                                  latest
                                </span>
                              )}
                            </div>
            ...
            <aside className="md:sticky md:top-24 h-fit space-y-4">
              ...
              <div className="bg-surface-raised border border-white/[0.08] rounded-lg p-5">
                ...
                <select
                  ...
                  onChange={() => {
                    /* Version switching could be implemented */
                  }}
                >
