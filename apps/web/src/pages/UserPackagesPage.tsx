...
export default function UserPackagesPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-mpak-gray-900 mb-2">My Packages</h1>
        <p className="text-mpak-gray-600">Manage and monitor your published MCP servers</p>
      </div>
      ...
      <div className="bg-surface-raised rounded-lg border border-white/[0.08] p-6 mb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <div className="text-2xl font-bold text-accent-gold-400 mb-1">{packages.length}</div>
      ...
      {!loading &&
        ...
        (packages.length > 0 ? (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm font-mono text-mpak-gray-500 mb-3">{pkg.name}</p>
          ...
          <div className="text-center py-16 bg-white rounded-lg border border-mpak-gray-200">
            ...
            <h3 className="text-lg font-semibold text-mpak-gray-900 mb-2">No packages yet</h3>
