...
const JWKS = jose.createRemoteJWKSet(new URL(`${GITHUB_OIDC_ISSUER}/.well-known/jwks`));
 ...
 */
export async function verifyGitHubOIDC(token: string): Promise<GitHubOIDCClaims> {
