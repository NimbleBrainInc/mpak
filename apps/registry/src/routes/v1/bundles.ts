              ...
              await packageRepo.upsertPackage(
                {
                  ...
                  authorName:
                    ((manifest['author'] as Record<string, unknown>)?.['name'] as string) ??
                    undefined,
                  authorEmail:
                    ((manifest['author'] as Record<string, unknown>)?.['email'] as string) ??
                    undefined,
                  authorUrl:
                    ((manifest['author'] as Record<string, unknown>)?.['url'] as string) ??
                    undefined,
