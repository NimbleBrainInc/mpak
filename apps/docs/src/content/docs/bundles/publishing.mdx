...
See [Scanning Your Bundle](/security/scanning) for detailed remediation guidance.
...
<CardGrid>
  <LinkCard title="Certification" description="Understand security levels and controls" href="/security/certification" />
